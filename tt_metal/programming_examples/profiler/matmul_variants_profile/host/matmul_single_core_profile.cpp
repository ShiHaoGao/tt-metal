...
void matmul_single_core(
    ...
    auto reader_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/profiler/matmul_variants_profile/kernels/single_core/dataflow/reader_single_core_mm.cpp",
        core,
    ...
    auto writer_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/profiler/matmul_variants_profile/kernels/single_core/dataflow/writer_single_core_mm.cpp",
        core,
        tt_metal::DataMovementConfig{
    ...
    tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/profiler/matmul_variants_profile/kernels/single_core/compute/mm.cpp",
        core,
...
int matmul_single_core_profile_example_main() {
    bool pass = true;
