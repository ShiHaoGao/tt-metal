...
void kernel_main() {
    ...
    constexpr uint32_t qktv_h_limit = get_compile_time_arg_val(35);
    constexpr bool salad_first_handoff = get_compile_time_arg_val(36) == 1;
    constexpr uint32_t qk_softmax_profile_stage = get_compile_time_arg_val(37);
    constexpr uint32_t qk_softmax_schedule = get_compile_time_arg_val(38);
