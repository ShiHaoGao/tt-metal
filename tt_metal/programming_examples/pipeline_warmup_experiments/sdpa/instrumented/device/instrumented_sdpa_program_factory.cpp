...
#include "tt_metal/programming_examples/pipeline_warmup_experiments/sdpa/instrumented/device/instrumented_sdpa_subblock_utils.hpp"
...
InstrumentedSDPAProgramFactory::cached_program_t InstrumentedSDPAProgramFactory::create(
    const InstrumentedSDPAParams& operation_attributes, const InstrumentedSDPAInputs& tensor_args, Tensor& tensor_return_value) {
    sdpa_instrumentation::ScopedStageTimer timer("program_factory_create");
    ...
    */
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        "tt_metal/programming_examples/pipeline_warmup_experiments/sdpa/instrumented/device/kernels/dataflow/reader_interleaved.cpp",
        core_grid,
        tt::tt_metal::ReaderDataMovementConfig(reader_compile_time_args, defines));

    auto writer_kernels_id = CreateKernel(
        program,
        "tt_metal/programming_examples/pipeline_warmup_experiments/sdpa/instrumented/device/kernels/dataflow/writer_interleaved.cpp",
        core_grid,
        tt::tt_metal::WriterDataMovementConfig(writer_compile_time_args, defines));

    auto compute_kernels_id = CreateKernel(
        program,
        "tt_metal/programming_examples/pipeline_warmup_experiments/sdpa/instrumented/device/kernels/compute/sdpa.cpp",
        core_grid,
...
void InstrumentedSDPAProgramFactory::override_runtime_arguments(
    cached_program_t& cached_program,
    const InstrumentedSDPAParams& operation_attributes,
    const InstrumentedSDPAInputs& tensor_args,
    Tensor& tensor_return_value) {
    sdpa_instrumentation::ScopedStageTimer timer("override_runtime_arguments");
