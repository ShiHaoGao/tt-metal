...
struct InstrumentedSDPAOperation {
    using operation_attributes_t = InstrumentedSDPAParams;
    using tensor_args_t = InstrumentedSDPAInputs;
    using spec_return_value_t = TensorSpec;
    using tensor_return_value_t = Tensor;
    using program_factory_t = std::variant<InstrumentedSDPAProgramFactory>;
