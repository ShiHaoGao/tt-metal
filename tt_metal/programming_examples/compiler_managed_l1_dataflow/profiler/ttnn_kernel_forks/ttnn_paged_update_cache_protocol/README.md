...
- `static-runtime` / `static-streamreg-cbregs` 模式只替换 hot cache/intermediate/output 流水的 CB 动态 FIFO 管理，仍保留原始 byte-row update、untilize/tilize 和 paged address math。
