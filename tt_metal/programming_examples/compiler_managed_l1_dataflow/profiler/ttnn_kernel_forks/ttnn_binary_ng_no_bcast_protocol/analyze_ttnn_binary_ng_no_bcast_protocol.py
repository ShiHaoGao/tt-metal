...
CASE_RE = re.compile(
    r"ttnn_binary_ng_no_bcast_protocol: tiles=(?P<tiles>\d+), tile_size=(?P<tile_size>\d+), "
...
def parse_args():
    parser = argparse.ArgumentParser(description="Summarize TTNN binary-ng no-bcast protocol profiler output.")
