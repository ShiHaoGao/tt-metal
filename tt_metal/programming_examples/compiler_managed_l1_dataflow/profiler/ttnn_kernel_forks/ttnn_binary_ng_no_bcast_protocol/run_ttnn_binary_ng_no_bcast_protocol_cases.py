...
from analyze_ttnn_binary_ng_no_bcast_protocol import (
    parse_device_zones,
    parse_host_results,
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run TTNN binary-ng no-bcast protocol profiler cases.")
    parser.add_argument(
        "--exe",
        type=Path,
        default=Path("build_Release/programming_examples/compiler_managed_l1_dataflow/profiler/ttnn_binary_ng_no_bcast_protocol"),
    )
    parser.add_argument("--out-dir", type=Path, default=Path("/tmp/ttnn_binary_ng_no_bcast_protocol_cases"))
