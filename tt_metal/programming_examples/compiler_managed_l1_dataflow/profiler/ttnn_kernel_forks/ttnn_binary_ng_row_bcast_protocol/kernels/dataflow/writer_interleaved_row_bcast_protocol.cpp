...
void kernel_main() {
    ...
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_COMPILETIME_WRITER");
#elif BENCH_USE_STREAM_REG_SYNC
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_WRITER");
#elif BENCH_USE_STREAM_REG_CBREGS
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_WRITER");
#else
    DeviceZoneScopedN("TBNGRB_STATIC_RUNTIME_WRITER");
#endif
    ...
    DeviceZoneScopedN("TBNGRB_CB_WRITER");
