...
#include "ttnn/cpp/ttnn/operations/eltwise/binary_ng/device/kernels/compute/eltwise_utils.hpp"
...
void kernel_main() {
    ...
    binary_op_init_common(kCbPostLhs, kCbPostRhs, kCbOut);
#ifdef PACK_RELU
    PACK((llk_pack_relu_config(ReluType::ZERO_RELU)));
#endif

#if not(HAS_ACTIVATIONS(LHS) or HAS_ACTIVATIONS(RHS) or HAS_ACTIVATIONS(POST))
    binary_tiles_init<true, BINARY_OP_TYPE>(kCbPostLhs, kCbPostRhs);
#endif
    ...
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_COMPILETIME_COMPUTE_UNPACK");
#elif defined(TRISC_MATH)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_COMPILETIME_COMPUTE_MATH");
#elif defined(TRISC_PACK)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_COMPILETIME_COMPUTE_PACK");
#endif
#elif BENCH_USE_STREAM_REG_SYNC
#if defined(TRISC_UNPACK)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_COMPUTE_UNPACK");
#elif defined(TRISC_MATH)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_COMPUTE_MATH");
#elif defined(TRISC_PACK)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_COMPUTE_PACK");
#endif
#elif BENCH_USE_STREAM_REG_CBREGS
#if defined(TRISC_UNPACK)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_COMPUTE_UNPACK");
#elif defined(TRISC_MATH)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_COMPUTE_MATH");
#elif defined(TRISC_PACK)
    DeviceZoneScopedN("TBNGRB_STATIC_STREAMREG_CBREGS_COMPUTE_PACK");
#endif
#else
#if defined(TRISC_UNPACK)
    DeviceZoneScopedN("TBNGRB_STATIC_RUNTIME_COMPUTE_UNPACK");
#elif defined(TRISC_MATH)
    DeviceZoneScopedN("TBNGRB_STATIC_RUNTIME_COMPUTE_MATH");
#elif defined(TRISC_PACK)
    DeviceZoneScopedN("TBNGRB_STATIC_RUNTIME_COMPUTE_PACK");
#endif
#endif
    ...
    for (uint32_t i = 0; i < num_tiles; ++i) {
        ...
        binary_tiles_init<true, BINARY_OP_TYPE>(kCbPostLhs, kCbPostRhs);
#endif
        BINARY_OP(kCbPostLhs, kCbPostRhs, 0, 0, 0);
...
#else
#if defined(TRISC_UNPACK)
    DeviceZoneScopedN("TBNGRB_CB_COMPUTE_UNPACK");
#elif defined(TRISC_MATH)
    DeviceZoneScopedN("TBNGRB_CB_COMPUTE_MATH");
#elif defined(TRISC_PACK)
    DeviceZoneScopedN("TBNGRB_CB_COMPUTE_PACK");
#endif
    ...
    auto process_tiles = [&](uint32_t n) {
        ...
        for (uint32_t i = 0; i < n; ++i) {
            BINARY_OP(kCbPostLhs, kCbPostRhs, i, i, i);
