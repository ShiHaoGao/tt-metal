...
constexpr std::string_view kReaderKernel =
    OVERRIDE_KERNEL_PREFIX "compiler_managed_l1_dataflow/profiler/ttnn_kernel_forks/real_matmul_protocol/kernels/dataflow/reader_bmm_tile_layout_protocol.cpp";
constexpr std::string_view kWriterKernel =
    OVERRIDE_KERNEL_PREFIX "compiler_managed_l1_dataflow/profiler/ttnn_kernel_forks/real_matmul_protocol/kernels/dataflow/writer_bmm_tile_layout_protocol.cpp";
constexpr std::string_view kComputeKernel =
    OVERRIDE_KERNEL_PREFIX "compiler_managed_l1_dataflow/profiler/ttnn_kernel_forks/real_matmul_protocol/kernels/compute/bmm_large_block_zm_protocol.cpp";
...
uint32_t protocol_start_value(Mode mode, uint32_t repeat) {
...
void create_circular_buffers(
    ...
    for (const auto& work : works) {
        ...
        const uint32_t in0_cb_tiles =
            static_input ? shape.in0_block_num_tiles * num_pages : shape.in0_block_num_tiles * 2;
        const uint32_t in1_cb_tiles =
            static_input ? shape.in1_block_num_tiles * num_pages : shape.in1_block_num_tiles * 2;
