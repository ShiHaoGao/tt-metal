...
#define SPM_ZONE_STATIC_STREAMREG_CBREGS_COMPILETIME_WRITER \
    SPM_CASE_PREFIX "_STATIC_STREAMREG_CBREGS_COMPILETIME_WRITER"
...
void kernel_main() {
    ...
    DeviceZoneScopedN(SPM_ZONE_STATIC_STREAMREG_CBREGS_COMPILETIME_WRITER);
