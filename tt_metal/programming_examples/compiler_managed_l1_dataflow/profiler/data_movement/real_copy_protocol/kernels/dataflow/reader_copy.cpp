...
#if BENCH_USE_COMPILE_TIME_ARGS
    DeviceZoneScopedN("RTCOPY_STATIC_COMPILETIME_READER");
#elif BENCH_USE_STREAM_REG_SYNC
    DeviceZoneScopedN("RTCOPY_STATIC_STREAMREG_SCRATCH_READER");
#else
    DeviceZoneScopedN("RTCOPY_STATIC_RUNTIME_READER");
#endif
